  ...
  return (
    <div className="w-screen">
      <button
        type="button"
        onClick={goToPost}
        className="w-16 h-16 rounded-full fixed bottom-6 right-[330px] md:right-8 md:bottom-7 sm:w-12 sm:h-12 sm:right-5 sm:bottom-4 transition duration-200 ease-in-out transform hover:scale-110 bg-blue border-2 border-slate-40 shadow-md shadow-slate-300 sm:shadow-slate-500"
      >
